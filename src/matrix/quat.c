...
quat_t quat_create(quat_t quat) {
    quat_t dest = calloc(sizeof(f32), 4);
...
quat_t quat_calculateW(quat_t quat, quat_t dest) {
    f32 x = quat[0], y = quat[1], z = quat[2];
...
quat_t quat_multiply(quat_t quat, quat_t quat2, quat_t dest) {
    ...
    f32 qax = quat[0], qay = quat[1], qaz = quat[2], qaw = quat[3],
...
quat_t quat_slerp(quat_t quat, quat_t quat2, f32 slerp, quat_t dest) {
    ...
    f32 cosHalfTheta = quat[0] * quat2[0] + quat[1] * quat2[1] + quat[2] * quat2[2] + quat[3] * quat2[3],
        halfTheta,
        sinHalfTheta,
        ratioA,
        ratioB;
